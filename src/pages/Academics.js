        ...
        <div class="glass-card" style="background: var(--pure-white); margin-bottom: 3rem; padding: 3rem;">
          <div class="grid grid-cols-2" style="gap: 4rem; align-items: center;">
            <div>
              ...
              <p style="color: var(--accent-red); font-weight: 700; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1px;">Nambale Shiners High School during sports</p>
            </div>
        ...
        <div class="glass-card" style="background: linear-gradient(135deg, var(--pure-white), var(--soft-gray)); padding: 3rem;">
          <div class="grid grid-cols-2" style="gap: 4rem; align-items: center;">
            <div style="order: 2;">
              ...
              <p style="color: var(--accent-red); font-weight: 700; font-size: 0.95rem; text-transform: uppercase; letter-spacing: 1px;">Creative Arts & Drama Team</p>
            </div>
            
            <div style="order: 1; display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem;">
