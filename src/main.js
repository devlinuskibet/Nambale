...
const seoMetadata = {
  'home': { title: 'Nambale Shiners High School | Official Website', desc: "Nurturing Tomorrow's Leaders and Human Resource Today. An exceptional discipline standards and academic commitment ecosystem at Shiners High." },
  'academics': { title: 'Academics - Nambale Shiners High School', desc: "Explore our Junior and Senior Secondary School programs, competitive sports, and modern learning facilities at one of the best schools in Nambale." },
  'admission_fees': { title: 'Admissions & Fees - Nambale Shiners High School', desc: "Join a winning community. Learn about our admission process, fee structure, and payment methods for Nambale Shiners High School." },
  'participate': { title: 'Get Involved - Nambale Shiners High School', desc: "Volunteer, mentor, and make an impact in our holistic academic community at Nambale Shiners." },
  ...
  'contact': { title: 'Contact Us - Nambale Shiners High School', desc: "Get in touch with Nambale Shiners High School. Find our location in Nambale, phone number, and email." },
